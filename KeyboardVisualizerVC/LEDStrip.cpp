...
void LEDStrip::SetLEDs(COLORREF pixels[64][256])
{
    ...
    {
        serial_buf[idx + 1] = GetRValue(pixels[3][128+(int)(idx * 2.84f)]);
        serial_buf[idx + 2] = GetGValue(pixels[3][128+(int)(idx * 2.84f)]);
        serial_buf[idx + 3] = GetBValue(pixels[3][128+(int)(idx * 2.84f)]);
    }
